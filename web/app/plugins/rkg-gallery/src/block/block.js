...
registerBlockType( 'cgb/block-rkggallery', {
	title: __( 'Album' ), // Block title.
				...
				images.map( ( image ) => {
					return (
						<div className="gallery-item-container">
							...
							<div className="remove-item" onClick={ () => removeImage( image ) }><span className="dashicons dashicons-trash"></span></div>
